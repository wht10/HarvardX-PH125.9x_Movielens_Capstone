---
title: "Movie_Recommendation_Report"
...
```{r correaltion of rating and # rating per movie}
...
```{r validation set RMSE calculation}
l <- lambda
...
The final RMSE for the validation data set is **.8648**, which is <**.86490**, indicating we have successfully met the accuracy performance requirement. 
